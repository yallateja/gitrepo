        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="${current == 'users' ? 'active' : ''}"><a href='<spring:url value="/addcontact"/>'>Add Contact</a></li>
              <li class="${current == 'register' ? 'active' : ''}"><a href='<spring:url value="/contactlist"/>'>Contact List</a></li>
